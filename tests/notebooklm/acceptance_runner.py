...
TESTS = ROOT / "tests"
NOTEBOOKLM_PACKAGE = "tests.notebooklm"
...
def _suite(module_name: str, prefix: str, selected_id: str | None) -> unittest.TestSuite:
    ...
    module = __import__(f"{NOTEBOOKLM_PACKAGE}.{module_name}", fromlist=[module_name])
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.related:
        return _subprocess_suite(
            [
                "tests.notebooklm.test_export_notebooklm",
                "tests.wiki.test_wiki_lint",
                "tests.installer.test_install_framework",
                "tests.notebooklm.test_notebooklm_acceptance",
