...
class StageHookContractTests(unittest.TestCase):
    ...
    def test_windows_linux_reports_require_one_functional_oracle(self) -> None:
        ...
        try:
            ...
            controlled_comparison = compare_portability_reports.compare_reports(controlled)
        finally:
        ...
        self.assertEqual("failed", controlled_comparison["outcome"])
        self.assertTrue(
            any(
                "controlled report is not admissible" in item
                for item in controlled_comparison["diagnostics"]
            ),
